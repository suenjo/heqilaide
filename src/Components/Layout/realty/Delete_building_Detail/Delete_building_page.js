...
import ImageUploadModal from './Delete_ImageUploadModal'; // 이미지 모달 컴포넌트
import './Delete_building_page.css'; // 스타일
    ...
    <div className="create-building-container">
      ...
      <div className="form-container">
        <form className="building-form" onSubmit={(e) => e.preventDefault()}>
          ...
          <label>지방: <span><div>큐슈</div>*필수</span></label>
          ...
          <text type="date" defaultValue="2024-07-01" required />

          <label>태그: <span>선택 사항</span></label>
          <text type="text" defaultValue="바닷가 전망, 접근성 좋음" />

          <label>담당직원: <span>*필수</span></label>
          <t type="text" defaultValue="오오하시 유키" required />

          <label>담당직원 코멘트: <span>*필수</span></label>
          <text defaultValue="바닷가 인근에 위치한 건물로, 조용하고 넓은 공간이 특징입니다." />
        ...
        <div className="form-buttons">
          ...
          <button className="save-btn" onClick={handleDelete}>삭제하기</button>
        </div>
      </div>
